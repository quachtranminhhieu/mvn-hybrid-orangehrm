...
//		Reporter.log("<br><a href=\"data:image/png;base64," + screenshotPath + "\">" + "<img src=\"data:image/png;base64," + screenshotPath + "\" " + "height='100' width='150'/> " + "</a></br>");	
	...
	public String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = GlobalConstants.getGlobalConstant().getReportNGScreenshotPath() + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
